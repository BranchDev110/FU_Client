...
const SideBar = () => {
    return (
        <aside class="w-64 h-screen bg-gray-900 relative" aria-label="Sidebar">
            <div class="overflow-y-auto  px-3 py-4 ">
                <div className='p-2 flex'>
                    <img class="w-30 h-24 mr-2 inline" src="branch-logo.png" alt="logo" />
                </div>
                <div className='p-6 mt-3 mb-5 bg-gray-800 rounded flex flex-col text-left text-white font-bold'>
                    <p>HP Notes</p>
                    <p className='text-sm text-gray-500'>Developed by @branch</p>
                </div>
                <ul class="space-y-2">
                    <li>
                ...
                <div id="dropdown-cta" class="absolute bottom-3 left-3 right-3 p-4 mt-6 rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
